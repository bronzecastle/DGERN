...
#set seed
    ...
    dsn.compile(optimizer=SGD(0.01,0.9),loss='kld')
    Embeded_z,q_pred=dsn.fit(maxiter=max_iter,)
    print("The dsn has been trained successfully!!!!!!")
    if verbose:
        print("The summary of dsn model is:")
        dsn.model.summary()
    print("The runtime of (resolution="+str(n_clusters)+")is:",get_time()-tic)
    ...
    adata.obs['dsn_'+str(louvain_resolution)]=y_pred
...
def train(data,dims=None,
    ...
    """ Deep Embeded single cell clustering(DSN) API
